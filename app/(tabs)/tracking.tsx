...
import { DARK_MAP_STYLE, GOOGLE_MAPS_MAP_ID } from '../../lib/map-style';
  ...
  return (
    <View style={[styles.container, { backgroundColor: dynamicTheme.background }]}>
      ...
      <View style={styles.topBar}>
        <TouchableOpacity style={[styles.backButton, { backgroundColor: dynamicTheme.card }]} onPress={() => router.push('/(tabs)/home')}>
